...
public:
    ...
    current_state_(FOLLOWING)
  {
    ...
    ft_.reset(new turtlebot_guide::FollowerTracker(0.01));
    ...
    ir1_sub_ = nh_.subscribe("/guidance/ir_camera_1/scan", 10,
                             &FollowerTrackerNode::IRCameraCallback, this);

    ir2_sub_ = nh_.subscribe("/guidance/ir_camera_2/scan", 10,
                             &FollowerTrackerNode::IRCameraTwoCallback, this);

    ir3_sub_ = nh_.subscribe("/guidance/ir_camera_3/scan", 10,
                             &FollowerTrackerNode::IRCameraThreeCallback, this);
  ...
  void IRCameraTwoCallback(const gazebo_ir_camera_plugin::IRCamera &msg)
  {
    ir_camera_2_msg_ = msg;
  }

  void IRCameraThreeCallback(const gazebo_ir_camera_plugin::IRCamera &msg)
  {
...
private:
  ...
  {
    double azi = 0.0;
//    ROS_INFO_STREAM(ir_camera_1_msg_.azimuthal_angles.size() << " " <<
//                    ir_camera_2_msg_.azimuthal_angles.size() << " " <<
//                    ir_camera_3_msg_.azimuthal_angles.size() << " ");
