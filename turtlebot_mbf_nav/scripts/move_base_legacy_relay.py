...
if __name__ == '__main__':
    ...
    mbf_mb_ac = actionlib.SimpleActionClient("turtlebot_mbf_nav/move_base", mbf_msgs.MoveBaseAction)
    mbf_gp_ac = actionlib.SimpleActionClient("turtlebot_mbf_nav/get_path", mbf_msgs.GetPathAction)
    ...
    mbf_drc = Client("turtlebot_mbf_nav", timeout=10)
